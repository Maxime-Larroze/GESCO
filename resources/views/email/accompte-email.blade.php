...
@section('email.accompte-email.show')
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 text-center card">
                <div class="card-body">
                    ...
                    <p class="text-center">
                        ...
                        <br>
                        Si le document en pièce-jointe est illisible, vous pouvez le consulter à <a href="{{URL::signedRoute('signed.exeternal.accompte', ['id' => $facture->id, 'user_id'=>$user->id])}}">cette adresse</a>
                        <br>
                    </p>
                    <p class="mb-5">
                        Cordialement,
                    ...
                    <p>Lien de consultation de votre facture d'accompte: {{URL::signedRoute('signed.exeternal.accompte', ['id' => $facture->id, 'user_id'=>$user->id])}}</p>
                    <br><br>
