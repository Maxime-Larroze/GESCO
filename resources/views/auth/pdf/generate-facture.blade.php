...
@section('auth.pdf.generate-facture.show')
        ...
        <div class="container-fluid">
            ...
            @if (Route::is('factures.pdf.show'))
                <div class="row">
                    ...
                    <div class="col-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4 text-center mt-5">
                        <button class="btn btn-dark mb-5" onclick="share('{{URL::signedRoute('signed.exeternal.facture', ['id' => $mission->id, 'user_id'=>$user->id])}}')"><i class="far fa-share-square"></i> Partager le lien sécurisé</button>
                    </div>
                    <div class="col-4 col-md-4 col-lg-4 col-xl-4 col-xxl-4 text-center mt-5">
